  ...
  <header>
    <nav class="nav">
      ...
      <ul class="nav__links">
        ...
        <li><NuxtLink class="nav__link" to="/offer">Oferta</NuxtLink></li>
        <li><NuxtLink class="nav__link" to="/about">O mnie</NuxtLink></li>
        <li><NuxtLink class="nav__link" to="/contact">Kontakt</NuxtLink></li>
      </ul>
      <div class="burger">
